...
%	\marking[doc:title]    {\xmlall{#1}{title}} % XXX: this is supposed to be the document title
%	\marking[doc:revision] {}
	\marking[doc:product]  {\xmlall{#1}{productname}}
	\marking[doc:author]   {\xmlall{#1}{author}}
%	\marking[doc:classify  {}
\stopxmlsetups

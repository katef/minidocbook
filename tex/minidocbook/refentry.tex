...
\startxmlsetups mdb:reference
	...
	\marking[Reference]{\xmltext{#1}{./title}} % XXX: not \xmltext, but \xmlall
...
\startxmlsetups mdb:collated-refentry
	...
	\startRefentry[title=\xmlconcat{#1}{refnamediv/refname}{, }(\xmltext{#1}{refmeta/manvolnum})]
...
%	\marking[Refentrytitle] {\xmltext{#1}{./refentrytitle}} % not used

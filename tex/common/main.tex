...
\definemarking[Company]  % Bubblephone Ltd.
\definemarking[Title]    % SID Users' Guide
\definemarking[Revision] % 4
\definemarking[Product]  % MCT
\definemarking[Author]   % Katherine Flavel
\definemarking[Classify] % Unrestricted
